...
public class GT_Cover_NeedMaintainance extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.fontRendererObj.drawString(buttontext[0],startX + spaceX*1, 4+startY+spaceY*0, colorText);
            this.fontRendererObj.drawString(buttontext[1],startX + spaceX*1, 4+startY+spaceY*1, colorText);
            this.fontRendererObj.drawString(buttontext[2],startX + spaceX*1, 4+startY+spaceY*2, colorText);
            this.fontRendererObj.drawString(buttontext[3],startX + spaceX*1, 4+startY+spaceY*3, colorText);
            this.fontRendererObj.drawString(buttontext[4],startX + spaceX*5 + 4, 4+startY+spaceY*0, colorText);
            this.fontRendererObj.drawString(buttontext[5],startX + spaceX*5 + 4, 4+startY+spaceY*1, colorText);
            this.fontRendererObj.drawString(buttontext[6],startX + spaceX*5 + 4, 4+startY+spaceY*2, colorText);
            //                                          inverted        normal
            String s2 = ((coverVariable & 0x1) > 0) ? buttontext[7] : buttontext[8];
            this.fontRendererObj.drawString(s2,  startX + spaceX*5 + 4, 4+startY+spaceY*3, colorText);
        }
