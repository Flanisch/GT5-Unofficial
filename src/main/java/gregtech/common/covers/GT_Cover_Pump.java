...
public class GT_Cover_Pump extends GT_CoverBehavior{
    ...
    private class GT_PumpGUICover extends GT_GUICover {
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.fontRendererObj.drawString(GT_Utility.trans("229", "Import/Export"),  startX + spaceX*3, 3+startY+spaceY*0, colorText);
            this.fontRendererObj.drawString(GT_Utility.trans("230", "Conditional"),     startX + spaceX*3, 3+startY+spaceY*1, colorText);
            this.fontRendererObj.drawString(GT_Utility.trans("231", "Enable Input"),   startX + spaceX*3, 3+startY+spaceY*2, colorText);
        }
