...
public class GT_GUIContainer_OutputHatch extends GT_GUIContainerMetaTile_Machine implements INEIGuiHandler {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (mContainer != null) {
            ...
            fontRendererObj.drawString(GT_Utility.parseNumberToString(((GT_Container_OutputHatch) mContainer).mContent), 10, 30, colorTextValue);
            fontRendererObj.drawString("Locked Fluid", 101, 20, colorText);
            ...
            fontRendererObj.drawString(fluidName, 101, 30, colorTextValue);
        }
    }
